export default class DoubleSlider {
  ...
  onMouseMove = event => {
    ...
    if(this.target.dataset.element === 'thumbLeft'){
      ...
      this.updatedRange.from = Math.round((this.min + parseFloat(this.target.style.left)) * (this.max - this.min) / 100);
      ...
      this.updatedRange.to = Math.round((this.max - parseFloat(this.target.style.right)) * (this.max - this.min) / 100);
